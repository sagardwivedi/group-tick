                ...
                {projectProgressData.map((project) => (
                  <div key={project.name} className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge
                        variant={project.progress === 0 ? "outline" : "default"}
                      >
                        {project.progress === 0
                          ? "Not Started"
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Your data shows higher productivity during morning hours.
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-sm font-medium">Reduce meeting time</h4>
                    <p className="text-sm text-muted-foreground mt-1">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-sm font-medium">Batch similar tasks</h4>
                    <p className="text-sm text-muted-foreground mt-1">
